        ...
        <section className="py-24 font-[Alexandria] bg-[#F4F1DE]">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 grid-cols-1">
                    <div className="lg:mb-0 mb-10">
                        <div className="group w-full h-full">
                            <div className="relative h-full">
                                <img  src="https://pagedone.io/asset/uploads/1696488602.png"  alt="Contáctanos"  className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-[#E07A5F] object-cover"/>
                                ...
                                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div className="bg-white rounded-lg p-6 block space-y-6">
                                        <div className="flex items-center">
                                            ...
                                            <h5 className="text-black text-base ml-5">+ 503 1122-3344</h5>
                                        </div>
                                        <a href="mailto:mixart@gmail.com" className="flex items-center">
                                            <svg width="30" height="30" fill="none" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h5 className="text-black text-base ml-5">mixart@gmail.com</h5>
                                        </a>
                                        <div className="flex items-center">
                                            <svg width="30" height="30" fill="none" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h5 className="text-black text-base ml-5">Calle La Mascota, San Salvador, El Salvador</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <button className="w-full h-12 bg-[#E07A5F] hover:bg-[#d46d58] text-white text-base font-semibold leading-6 rounded-full transition duration-300 shadow-sm font-[Alexandria]">
                        Enviar mensaje
                    </button>
                    </div>
                </div>
