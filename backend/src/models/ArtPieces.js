...
const artPiecesSchema = new Schema(
    {
      ...
      discount: { type: Number, required: true, validate: { validator: function (value) { return value !== 0; }, message: "El descuento no puede ser 0"}, min: [0, "El descuento no puede ser menor que 0"], max: [100, "El descuento no puede exceder el 100%"], },
    },
    {
        timestamps: true,
        strict: false,
